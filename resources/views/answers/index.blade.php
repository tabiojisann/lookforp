    ...
    <div class="row">
      ...
      <div class="container">
        <div class="col text-center">
          @if($answers->count() >= 5 && $answers[4]->count_likes >= 1)
            <div class="my-2">
              <a href="{{ route('answers.rank') }}">ランキング</a>
            </div>
          @endif
        </div>
      </div>

      <div class="border text-center col-10 offset-1 col-md-8 offset-md-2 mb-5">
            ...
            <div class="text-right">
              @if(Auth::id() === $answer->user_id)
                <div class="dropdown">
                  ...
                  <!--Menu-->
                  <div class="dropdown-menu dropdown-primary  animated fadeIn faster" style="max-width: 20px;">
